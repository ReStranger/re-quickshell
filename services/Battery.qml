        ...
        function onBatteryLvlChanged() { 
            ...
            if (root.batteryLvl <= Config.options.battery.critical && root.notifiedLevel > Config.options.battery.critical) {
                ...
                Quickshell.execDetached({
                    command: ["notify-send", "--urgency=critical", "Battery critically low", "Emergency shutdown imminent unless plugged in."]
                });
                ...
                Quickshell.execDetached({
                    command: ["notify-send", "--urgency=critical", "Battery very low", "Please plug in your charger now."]
                });
                ...
                Quickshell.execDetached({
                    command: ["notify-send", "--urgency=critical", "Low battery", "Consider plugging in your charger."]
                });
            }
        }
    }
